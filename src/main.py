...
qm.load_querys()
data = qm.execute_query("city_streets",5000,48.051536,8.206198)
dm.add_data("city_streets", data)
dm.save_data_to_file("city_streets", "city_streets.json")

qm.load_querys()
data = qm.execute_query("forest_roads",5000,48.051536,8.206198)
dm.add_data("forest_roads", data)
dm.save_data_to_file("forest_roads", "forest_roads.json")

qm.load_querys()
data = qm.execute_query("foot_paths",5000,48.051536,8.206198)
...
plot(rescale_matrix(np.add(interurban_roads, city_streets, forest_roads, foot_paths)))
